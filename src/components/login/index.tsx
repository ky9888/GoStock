...
const LoginForm: React.FC = () => {
  ...
  return (
    <div className=" grow  my-[8%] px-[30%] max-lg:px-[7%] ">
      <form
        className="rounded-lg space-y-2 w-full  shadow-[0_0px_70px_-5px_rgba(0,0,0,0.1)] p-5"
      ...
      >
        ...
        >
          ...
          <p className="text-blue-500">Đăng nhập với google</p>
        </a>
